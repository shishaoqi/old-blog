    ...
    <div class="col-sm-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="{{url('admin/category/'.$id)}}" method="post" role="form" class="form-horizontal">
                    <input type="hidden" class="form-control" id="field-20" name="_method" value="put">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" class="form-control" id="field-19" name="id" value="{{ $id }}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="field-2" name="title" value="{{$category['title']}}">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="field-3" name="keywords" value="{{$category['keywords']}}">Example block-level help text here. Emails inputs are validated on native HTML5 forms.</p>
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="field-3" placeholder="" name="order" value="{{$category['order']}}">
                        </div>
                    </div>
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" cols="5" id="field-5" name="description">{{$category['description']}}</textarea>
                        </div>
                    </div>
                    <!-- <div class="form-group-separator"></div> 
                    <div class="form-group">
